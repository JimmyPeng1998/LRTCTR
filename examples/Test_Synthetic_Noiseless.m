...
PA=TR_sample(Atemp,Omega);
PAGamma=TR_sample(Atemp,Gamma);
    ...
    switch i
        case 1 % TR-RGD (Armijo)
            ...
            opts=struct('maxiter',maxIter,'maxTime',maxTime,...
                'train_tol',err,'tol',1e-8,'gradtol',1e-8,...
...
for i=selectedSolver
    semilogy(duration{i},error{i},'LineWidth',lwidth,'Color',colors(i,:),'Marker','^','MarkerSize',msize,'MarkerFaceColor',colors(i,:),'MarkerEdgeColor','none')
    hold on
end
...
figure()
for i=selectedSolver
    semilogy(duration{i},errorGamma{i},'LineWidth',lwidth,'Color',colors(i,:),'Marker','^','MarkerSize',msize,'MarkerFaceColor',colors(i,:),'MarkerEdgeColor','none')
    hold on
end
