function [Xnew, duration, errorOmega, errorGamma, info] = ...
    TR_RCGQ(X, PA, Omega, varargin)
%TR_RCGQ Riemannian conjugate gradient on the TR quotient manifold.
%
% Basic interface:
%   [Xnew, duration, errorOmega] = TR_RCGQ(X, PA, Omega, opts)
%
% Interface with test statistics:
%   [Xnew, duration, errorOmega, errorGamma, info] = ...
%       TR_RCGQ(X, PA, Omega, PAGamma, Gamma, opts)
%
% Input:
