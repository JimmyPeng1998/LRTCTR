function [Xnew, duration, errorOmega, errorGamma] = TR_RGD_exact(X, PA, Omega, varargin)
%TR_RGD_EXACT Preconditioned TR-RGD with exact line search.
%
% Simplified interface:
%   [Xnew, duration, errorOmega] = ...
%       TR_RGD_exact(X, PA, Omega, opts)
%
% Simplified interface with test statistics:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RGD_exact(X, PA, Omega, PAGamma, Gamma, opts)
%
% Legacy interface:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RGD_exact(X, PA, Omega, SizeOmega, PAGamma, Gamma, ...
%       SizeGamma, p, opts)
%
% Input:
...
[Xnew, duration, errorOmega, errorGamma] = TR_compat_dispatch( ...
    @TR_RGD_exact_legacy, X, PA, Omega, varargin{:});
end
