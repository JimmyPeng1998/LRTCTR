function [Xnew,duration,errorOmega,errorGamma]=TR_RGD_Armijo_legacy(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
%TR_RGD_ARMIJO_LEGACY Legacy preconditioned TR-RGD with Armijo line search.
%
...
%         toc
        ...
        while t>1e-10
            ...
            if 0.5*errorOmega(epoch-1)/p-0.5*errorOmegaNow/p>(2^-13)*t*GradAndDirec
                break
            end
...
%             Dnew{k}=alpha*Dnew{k};
%         end
        GradAndDirec=RiemannInner(Gnew,Hnew,Gnew,d);
