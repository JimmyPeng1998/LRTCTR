function [Xnew,duration,errorOmega,errorGamma]=TR_RGN_legacy(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
%TR_RGN_LEGACY Legacy preconditioned Riemannian Gauss--Newton method.
%
