function [Xnew,duration,errorOmega,errorGamma]=TR_RGD_exact_legacy(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
%TR_RGD_EXACT_LEGACY Legacy preconditioned TR-RGD with exact line search.
%
...
for epoch=1:opts.maxiter
    ...
    if epoch==1
        ...
        %             if 0.5*errorOmega(epoch-1)/p-0.5*errorOmegaNow/p>0.00001*t*GradAndDirec
        %                 t
        %                 break
        %             end
        %
