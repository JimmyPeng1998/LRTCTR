function [Xnew,duration,errorOmega,errorGamma]=TR_RCG_HS_legacy(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
%TR_RCG_HS_LEGACY Legacy preconditioned TR-RCG with the Hestenes--Stiefel rule.
%
