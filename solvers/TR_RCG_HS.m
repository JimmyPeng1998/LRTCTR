function [Xnew, duration, errorOmega, errorGamma] = TR_RCG_HS(X, PA, Omega, varargin)
%TR_RCG_HS Preconditioned TR-RCG with the Hestenes--Stiefel rule.
%
% Simplified interface:
%   [Xnew, duration, errorOmega] = ...
%       TR_RCG_HS(X, PA, Omega, opts)
%
% Simplified interface with test statistics:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RCG_HS(X, PA, Omega, PAGamma, Gamma, opts)
%
% Legacy interface:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RCG_HS(X, PA, Omega, SizeOmega, PAGamma, Gamma, ...
%       SizeGamma, p, opts)
%
% Input:
...
[Xnew, duration, errorOmega, errorGamma] = TR_compat_dispatch( ...
    @TR_RCG_HS_legacy, X, PA, Omega, varargin{:});
end
