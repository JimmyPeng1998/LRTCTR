function [Xnew, duration, errorOmega, errorGamma] = TR_RGD_Armijo(X, PA, Omega, varargin)
%TR_RGD_ARMIJO Preconditioned TR-RGD with Armijo line search.
%
% Simplified interface:
%   [Xnew, duration, errorOmega] = ...
%       TR_RGD_Armijo(X, PA, Omega, opts)
%
% Simplified interface with test statistics:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RGD_Armijo(X, PA, Omega, PAGamma, Gamma, opts)
%
% Legacy interface:
%   [Xnew, duration, errorOmega, errorGamma] = ...
%       TR_RGD_Armijo(X, PA, Omega, SizeOmega, PAGamma, Gamma, ...
%       SizeGamma, p, opts)
%
% Input:
...
[Xnew, duration, errorOmega, errorGamma] = TR_compat_dispatch( ...
    @TR_RGD_Armijo_legacy, X, PA, Omega, varargin{:});
end
