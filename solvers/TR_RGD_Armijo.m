function [Xnew,duration,error,errorGamma]=TR_RGD_Armijo(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
% function M = [Xnew,duration,error,errorGamma]=TR_RGD_Armijo(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
% 
% Riemannian gradient descent algorithm with Armijo backtracking linesearch
% for tensor ring completion.
%
