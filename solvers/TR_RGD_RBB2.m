function [Xnew,duration,error,errorGamma]=TR_RGD_RBB2(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
% function M = [Xnew,duration,error,errorGamma]=TR_RGD_Armijo(X,PA,Omega,SizeOmega,PAGamma,Gamma,SizeGamma,p,opts)
% 
% Riemannian gradient descent algorithm with Riemannian Barzilai--Borwein
% stepsize rule for tensor ring completion.
%
