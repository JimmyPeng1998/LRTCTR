function [Xnew, duration, errorOmega, errorGamma, info] = ...
    uTR_RGDQ(X, PA, Omega, varargin)
%UTR_RGDQ Riemannian gradient descent on the uniform TR quotient manifold.
%
% Basic interface:
%   [Xnew, duration, errorOmega] = uTR_RGDQ(X, PA, Omega, opts)
%
% Interface with test statistics:
%   [Xnew, duration, errorOmega, errorGamma, info] = ...
%       uTR_RGDQ(X, PA, Omega, PAGamma, Gamma, opts)
%
% Input:
